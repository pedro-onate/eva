...
void test_1() {
  ...
  es_assert("unspecified should have unspecified type", es_unspecified_type == es_type_of(es_unspecified));
  ...
  es_assert("closure should have closure type",         es_closure_type     == es_type_of(es_closure_new(ctx, es_nil, es_nil, es_nil));
  es_assert("port should have port type",               es_port_type        == es_type_of(es_port_new(ctx, NULL)));
  es_assert("character should have character type",     es_character_type   == es_type_of(es_character_new('c')));
